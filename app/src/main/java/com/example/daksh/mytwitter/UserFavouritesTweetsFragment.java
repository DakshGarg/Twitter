...
public class UserFavouritesTweetsFragment extends Fragment {
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.user_favourites_tweets, container, false);
        listView = (ListView) v.findViewById(R.id.userFavouritesTweetsListView);
        tweetArrayList=new ArrayList<>();
        Bundle bundle = getArguments();
        String screen_name = bundle.getString("screen_name");
        ApiInterface apiInterface = ApiClient.getApiInterface();
        Call<List<Tweet>> call = apiInterface.getFavouriteTweets(screen_name);
